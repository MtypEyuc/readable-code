    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                if (doesUserWinTheGame() == 1) {
                    System.out.println("지뢰를 모두 찾았습니다. GAME CLEAR!"); //스테이터스 체크
                    break;
                }
                if (doesUserLoseTheGame() == -1) {
                    System.out.println("지뢰를 밟았습니다. GAME OVER!"); //스테이터스 체크
                    break;
                }

                String cellInput = getCellInputFromUser(); //스캐너
...
//        System.out.println("잘못된 번호를 선택하셨습니다.");
    ...
    private static int doesUserLoseTheGame() {
        return gameStatus;
    }

    private static int doesUserWinTheGame() {
        return gameStatus;
    }
    ...
    private static boolean isAllCellChecked() {
        return Arrays.stream(BOARD) // Stream<String[]>
                ...
                .allMatch(Cell::isChecked); //상수를 사용하는 것이 안전함.
    }
